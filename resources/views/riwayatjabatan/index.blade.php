...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      List Riwayat Jabatan
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i> Home</a></li>
      <li class="active">List Riwayat Jabatan</li>
    </ol>
  </section>
...
<script>
    ...
    function addForm() {
      ...
      $('.modal-title').text('Tambah Riwayat Jabatan');
    }
