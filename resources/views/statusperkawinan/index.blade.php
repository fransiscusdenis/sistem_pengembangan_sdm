...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">List Status Perkawinan</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <a class="btn btn-success" onclick="addForm()"><i class="fa fa-plus"></i> Tambah Data Status Perkawinan</a>
            </h3>
            {{-- <div class="box-tools">
...
<script>
    var table = $('#unit-table').DataTable({
                  processing: true,
                  serverSide: true,
                  ajax: "{{ route('api.statusperkawinan') }}",
                  columns: [
                    {data: 'id', name: 'id'},
    ...
    function addForm() {
      ...
      $('.modal-title').text('Tambah Status Perkawinan');
    }
    ...
    function editForm(id) {
      ...
      $('#modal-form form')[0].reset();
      $.ajax({
        url: "{{ url('statusperkawinan') }}" + '/' + id + "/edit",
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          $('#modal-form').modal('show');
          $('.modal-title').text('Edit Status Perkawinan');
    ...
    $(function(){
          $('#modal-form form').validator().on('submit', function (e) {
              if (!e.isDefaultPrevented()){
                  var id = $('#id').val();
                  if (save_method == 'add') url = "{{ url('statusperkawinan') }}";
                  else url = "{{ url('statusperkawinan') . '/' }}" + id;
