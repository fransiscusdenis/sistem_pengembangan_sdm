...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">List Status Hukum</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <a class="btn btn-success" onclick="addForm()"><i class="fa fa-plus"></i> Tambah Data Status Hukum</a>
            </h3>
            {{-- <div class="box-tools">
...
<script>
    ...
    function addForm() {
      ...
      $('.modal-title').text('Tambah Status Hukum');
    }
    ...
    function editForm(id) {
      ...
      $('#modal-form form')[0].reset();
      $.ajax({
        url: "{{ url('statushukum') }}" + '/' + id + "/edit",
        type: "GET",
        dataType: "JSON",
        success: function(data) {
          $('#modal-form').modal('show');
          $('.modal-title').text('Edit Status Hukum');
    ...
    $(function(){
          $('#modal-form form').validator().on('submit', function (e) {
              if (!e.isDefaultPrevented()){
                  var id = $('#id').val();
                  if (save_method == 'add') url = "{{ url('statushukum') }}";
                  else url = "{{ url('statushukum') . '/' }}" + id;
