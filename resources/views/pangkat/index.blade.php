...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">List Pangkat</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <a class="btn btn-success" onclick="addForm()"><i class="fa fa-plus"></i> Tambah Data Pangkat</a>
            </h3>
            {{-- <div class="box-tools">
...
<script>
    var table = $('#unit-table').DataTable({
                  ...
                  columns: [
                    ...
                    {data: 'jenis_pangkat', name: 'jenis_pangkat'},
    ...
    function editForm(id) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#jenis_pangkat').val(data.jenis_pangkat);
