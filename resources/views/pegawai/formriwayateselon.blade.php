<div class="modal" id="modal-form-eselon" tabindex="1" role="dialog" aria-hidden="true" data-backdrop="static">
            ...
            <form id="form-unit" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                          <input type="text" id="jabatann" name="jabatan" class="form-control" required>
                          <span class="help-block with-errors"></span>
                      </div>
                    </div>
                </div>
