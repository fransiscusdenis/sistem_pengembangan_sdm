...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      List Riwayat Pangkat
    </h1>
    <ol class="breadcrumb">
      <li><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i> Home</a></li>
      <li class="active">List Riwayat Pangkat</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <a class="btn btn-success" onclick="addForm()"><i class="fa fa-plus"></i> Tambah Data Riwayat Pangkat</a>
            </h3>
            {{-- <div class="box-tools">
...
<script>
    ...
    function addForm() {
      ...
      $('.modal-title').text('Tambah Riwayat Pangkat');
    }
